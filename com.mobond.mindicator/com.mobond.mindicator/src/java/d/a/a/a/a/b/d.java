...
implements f {
    ...
    boolean a(Context context) {
        try {
            int n2 = (Integer)Class.forName((String)"com.google.android.gms.common.GooglePlayServicesUtil").getMethod("isGooglePlayServicesAvailable", new Class[]{Context.class}).invoke(null, new Object[]{context});
            boolean bl = false;
            if (n2 == 0) {
                bl = true;
            }
