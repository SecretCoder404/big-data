...
extends LinearLayout {
    ...
    private int i;
    private float j;
    private SlidingTabLayoutLocal.c k;
    ...
    h(Context context, AttributeSet attributeSet) {
        ...
        this.e = h.a(n2, (byte)38);
        this.h = new a();
        this.h.a(new int[]{-1});
        a a2 = this.h;
        int[] arrn = new int[]{h.a(n2, (byte)32)};
        a2.b(arrn);
        this.a = (int)(2.0f * f2);
        this.b = new Paint();
        ...
        this.g = 0.0f;
        this.f = new Paint();
        this.f.setStrokeWidth((float)((int)(f2 * 0.0f)));
    }
    ...
    void a(SlidingTabLayoutLocal.c c2) {
        this.k = c2;
        this.invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f3 = n2;
        int n4 = (int)(f2 * f3);
        SlidingTabLayoutLocal.c c2 = this.k;
        if (c2 == null) {
            c2 = this.h;
        }
        SlidingTabLayoutLocal.c c3 = c2;
        if (n3 > 0) {
    ...
    implements SlidingTabLayoutLocal.c {
        private int[] a;
        private int[] b;
