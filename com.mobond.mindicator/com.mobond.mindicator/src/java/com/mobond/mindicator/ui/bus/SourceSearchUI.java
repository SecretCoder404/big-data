...
extends e {
    ...
    public void onCreate(Bundle bundle) {
        ...
        String[] arrstring = a.a((Context)this, ConfigurationManager.c(this.getApplicationContext()), this.P, ConfigurationManager.a((Context)this), "A:T:20210102").c();
    ...
    protected void onStart() {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable(this){
            final /* synthetic */ SourceSearchUI a;
            {
                this.a = sourceSearchUI;
            }
